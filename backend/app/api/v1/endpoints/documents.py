...
from ....models.result import ResultCreate, ResultUpdate # Added ResultUpdate
from ....models.enums import DocumentStatus, ResultStatus, FileType # Import enums
...
from ....services.blob_storage import upload_file_to_blob # Adjust path
